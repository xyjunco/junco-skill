...
Junco is a model-agnostic methodology and reusable skill package for product requirement analysis, product modeling, and high-quality PRD writing.

It helps turn raw needs, vague feature requests, stakeholder feedback, operational pain points, platform/system ideas, or existing PRDs into structured product documents with clear problems, concepts, models, flows, rules, milestones, and acceptance criteria.

## 中文说明

### 这套方法解决什么问题

Junco 适用于各类大模型和智能体，用于把“想做一个功能”“有个产品想法”“这里体验不好”这类原始需求，转成可评审、可设计、可开发、可验收的 PRD。
...
复杂平台、系统、流程、治理、运营类产品默认进入完整 PRD 模式，不输出轻量提纲，除非用户明确要求。
...
- 强化《做一个好产品》的全文方法论总结，不再只围绕单点关键词。
- 新增第一性原理需求反思，要求在接受用户实现路径前先反推真实问题。
- 强化“用户提出的路径只是候选方案”的规则，鼓励寻找更普世、更简洁的实现方式。
- 在 PRD 模板、深度门槛和评审清单中加入需求反思、假设挑战、替代路径和最小充分方案判断。

## English

### What This Skill Is For

Junco helps any capable language model or AI agent turn raw product input into rigorous product requirements.
...
Before drafting or reviewing a PRD, Junco asks:
...
```text
Use junco to turn this product request into a PRD.
```
